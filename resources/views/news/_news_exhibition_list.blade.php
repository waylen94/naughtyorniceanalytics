...
<div class="row">
      <div class="col-md-6">
         <div class="card text-white bg-primary flex-md-row mb-4 shadow-sm h-md-250">
            ...
            <img class="card-img-right flex-auto d-none d-lg-block" alt="Thumbnail" src="http://placeimg.com/360/480/nature" style="width: 200px; height: 250px;">
         </div>
      </div>
      <div class="col-md-6">
   ...
   <div class="row">
      <div class="col-md-4">
         <div class="card mb-4">
            <img class="card-img-top" src="http://placeimg.com/480/360/any" alt="Card image cap">
            <div class="card-body">
