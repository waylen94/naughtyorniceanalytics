      ...
      <div class="col-md-6">
         <div class="card text-white bg-primary flex-md-row mb-4 shadow-sm h-md-250">
            <div class="card-body d-flex flex-column align-items-start">
               <strong class="d-inline-block mb-2 text-white">Title Example</strong>
               <h6 class="mb-0">
            ...
            <img class="card-img-right flex-auto d-none d-lg-block" alt="Thumbnail" src="" style="width: 200px; height: 250px;">
         </div>
      </div>
      <div class="col-md-6">
   ...
   <div class="row">
      <div class="col-md-4">
         <div class="card mb-4">
            ...
            <div class="card-body">
               <h5 class="card-title">Title Example</h5>
